...
function eqComposeAdd(){const target=rnd(10,20);return{type:'compose_add',kind:'compose_pair',question:`Find TWO ways to make <strong>${target}</strong>.`,target,hint:hintComposeAdd(target)};}
function eqComposeSub(){const diff=rnd(4,10);return{type:'compose_sub',kind:'compose_pair',question:`Find TWO pairs of numbers with a difference of <strong>${diff}</strong>.`,target:diff,hint:hintComposeSub(diff)};}
function eqFactFamily(){let a,b,g=0;do{a=rnd(3,12);b=rnd(3,12);g++;}while(a===b&&g<200);const total=a+b;return{type:'fact_family',question:`Using ${a}, ${b}, and ${total}, fill in all four facts:`,a,b,total,hint:hintFactFamily(a,b,total)};}
...
const wordsComposeAdd=[
  {type:'compose_add',kind:'compose_pair',question:'Find TWO ways to make <strong>15</strong> using two groups of 🏎️ cars.',target:15,hint:hintComposeAdd(15)},
  {type:'compose_add',kind:'compose_pair',question:'Find TWO ways to make <strong>12</strong> using two groups of 🏁 flags.',target:12,hint:hintComposeAdd(12)},
  {type:'compose_add',kind:'compose_pair',question:'Find TWO ways to make <strong>18</strong> using two groups of 🏆 trophies.',target:18,hint:hintComposeAdd(18)},
  {type:'compose_add',kind:'compose_pair',question:'Find TWO ways to make <strong>10</strong> using two groups of ⚙️ gears.',target:10,hint:hintComposeAdd(10)},
  {type:'compose_add',kind:'compose_pair',question:'Find TWO ways to make <strong>20</strong> using two groups of 🔩 bolts.',target:20,hint:hintComposeAdd(20)}
];
...
const wordsFactFamily=[
  {type:'fact_family',question:'Using 5, 7, and 12, fill in all four facts:',a:5,b:7,total:12,hint:hintFactFamily(5,7,12)},
  {type:'fact_family',question:'Using 4, 9, and 13, fill in all four facts:',a:4,b:9,total:13,hint:hintFactFamily(4,9,13)},
  {type:'fact_family',question:'Using 6, 8, and 14, fill in all four facts:',a:6,b:8,total:14,hint:hintFactFamily(6,8,14)},
  {type:'fact_family',question:'Using 3, 10, and 13, fill in all four facts:',a:3,b:10,total:13,hint:hintFactFamily(3,10,13)},
  {type:'fact_family',question:'Using 7, 6, and 13, fill in all four facts:',a:7,b:6,total:13,hint:hintFactFamily(7,6,13)}
];
const wordsLogic=[
